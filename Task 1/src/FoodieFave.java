...
public class FoodieFave {
    ...
    private static String[] Queue1 = new String[2]; // First queue with a size of 2
    private static String[] Queue2 = new String[3]; // Second queue with a size of 3
    private static String[] Queue3 = new String[5]; // Third queue with a size of 5
    private static String[] QueueData = new String[10]; // Data array to store queue information
    ...
    private static void Addcustomer(Scanner input) {
        try {System.out.println("Enter the Customer name:");
        ...
        try {
            ...
            if (foundCustomer) {
                ...
                if (queueOption == 1) {
                    ...
                    Queue2[2] = null; // Set the last element to null
                } else if (queueOption == 3) {
